...
<body style="zoom:90%">
    ...
    <section class="py-5 cardtopsection">
        <div class="Form-Container container">
            <form action="ConformPublish.html">
                <div class="row">
                    <label for="Select" class="form-label">
                        <p class="Form-Categoryt1">Request Title</p>
                    </label>
                    <div class="col-sm-6 col-12 pb-3">
                        <input type="text" id="TextInput" class="form-control" placeholder="Request title">
                    </div>
                ...
                <div class="row pb-2">
                    ...
                    <div class="col-sm-6 col-12">
                        ...
                        <input type="text" id="TextInput" class="form-control" placeholder="price">
                    </div>
                </div>
                <div class="row" style="    padding-bottom: 1rem!important;">
                    <div class="col-sm-6 col-12">
                        ...
                        <input type="text" id="TextInput" class="Position-fromImg form-control" placeholder="Le Berdo">
                    </div>
                </div>
                <div class="pt-3">
                ...
                <div class="row pt-5 descriptiontop">
                    <div class="col-md-9 col-sm-12 col-12">
                        ...
                        <textarea type="text" id="TextInput" class="from-description1 form-control" placeholder="Detailed description"></textarea>
                    </div>
                </div>
                ...
                <div class="row" style="padding-bottom: 10px;">
                    <div class="col-md-9 col-sm-12 col-12">
                        ...
                        <div class="upload-Picture">
                            <img class="upload-PictureIMG" src="{{('theme/icons/ic_add_a_photo_24px.png')}}">
                        </div>
                    </div>
                </div>
                <div class="row pt-3" style="padding-bottom: 20px;">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-xs-6 col-6 pl-11">
                        <button class="form-button1 btn btn-primary confirmcancel">Confirm</button>
                    </div>
                </div>
            </form>
        </div>

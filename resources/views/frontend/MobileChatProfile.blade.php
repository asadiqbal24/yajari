...
<head>
    ...
    <link rel="stylesheet" href="MobileChatProfileStyle.css">
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarCollapse" style="margin-left:6%">
                        <div class="navbar-nav">
                            <a  style=" padding-top: 10px;color: #3B3B3B;font-weight: bold;
    position: relative;
    left: 2px;
" href="HomePage.html" class="nav-item nav-link active">Home</a>
            ...
            <div class="ReviewRow row">
                <div class="row mb-2">
                    <div class="col d-flex">
                        <img src="icons/ic_place_24px.png" style="width: 1rem; height: 1.5rem;">
                ...
                <div class="row mb-3">
                    <div class="col d-flex">
                        <img src="icons/ic_date_range_24px.png" style="width: 1rem; height: 1.2rem;">
                        <p class="ReviewText1">Joined by May 2020</p>
                    </div>
                </div>
                
                <div class="row">
                    <a href="PinkLeaveReview.html" style="    background: linear-gradient(to right,#ff8dad,#ff2160);text-decoration: none;
    ...
    padding: 8px 10px;padding-inline: 20px;">
                        <img src="icons/whitestar.png" alt="" class="whitestar">Leave your review
                    </a>
                </div>
            </div>
        </div>

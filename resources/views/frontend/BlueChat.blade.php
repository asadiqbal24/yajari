                ...
                <div class="col-md-3 col-sm-12 col-12">
                    ...
                    <div class="row mb-2">
                        <div class="card car_heightmobile" style="max-width: 540px;height: 85px;">
                            <div class="row g-0">
                                <div class="col-xxl-2 col-lg-3 col-md-2">
                                    <img src="icons/Ellipse -3.png" class="CardImg">
                                </div>
                                <div class="col-xxl-10 col-lg-9 col-md-10">
                                    <div class="card-body">
                                        <div class="row">
                    ...
                    <div class="row mb-2">
                        <div class="card car_heightmobile" style="max-width: 540px;height: 85px;">
                            <div class="row g-0">
                                <div class="col-xxl-2 col-lg-3 col-md-2">
                                    <img src="icons/Ellipse -2.png" class="CardImg">
                                </div>
                                <div class="col-xxl-10 col-lg-9 col-md-10">
                                    <div class="card-body">
                                        <div class="row">
                ...
                <div class="col-md-6 col-sm-12 col-12 mr-l_00">
                    <div class="LookingForMoveRow1 row" style="position: relative;">
                        ...
                        <a class="ChatViewRequestButton" href="ViewRequest.html">
                            <img src="icons/blueeyes.png" alt="">
                        </a>
                    </div>
                        ...
                        <div class="ChatMessagesRow row pt-5">
                            <div class="row">
                                ...
                                <div class="col-xxl-1 col-lg-3 col-md-2 text-end">
                                    <a href="ProfessionalProfile.html"> <img src="icons/Ellipse -1.png" style="width: 3rem;"></a>
                                </div>
                            </div>
                            <div class="row">
                        ...
                        <div class="onlineCard card" style="max-width: 540px;height: 115px;">
                            <div class="row g-0">
                                <div class="col-md-3 col-sm-4 col-4">
                                    <a href="ProfessionalProfile.html"> <img src="icons/Ellipse -1.png" class="CardImg" style="width: 4rem;margin-top: 1rem;"></a>
                    ...
                    <div class="ReviewRow row" style="position: relative;">
                        <div class="row mb-2">
                            <div class="col d-flex">
                                <img src="icons/ic_place_-8.png" style="width: 1rem; height: 1.5rem;">
                                <p class="ReviewText1">Librada, france</p>
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="col d-flex">
                                <img src="icons/Group 2411.png" style="width: 7rem; height: 1rem; margin-top: 0.15rem;">
                                <p class="ReviewText1"><b>4.5</b></p>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col d-flex">
                                <img src="icons/ic_date_range_-1.png" style="width: 1rem; height: 1.2rem;">
                        ...
                        <div class="row">
                            ...
                            <button href="LeaveReview.html" style="background: linear-gradient(to right,#9bd6e2,#21beea);
                                        ...
                                        border-radius: 8px;
                                        color: white;
                                        padding: 8px 10px;"><img src="icons/whitestar.png" style="    position: relative;
                                        top: -2px;
                                        padding-inline: 5px;" alt="">Leave your review</button>
    ...
    <section>
        <div class="container" style="width: 80%;">
            <div class="row" style="margin: auto;">
                <img src="icons/yajari-removebg-preview-1.png" style="width: auto;
                            height: auto;
                            margin: auto;
                            opacity: .30;">
            </div>

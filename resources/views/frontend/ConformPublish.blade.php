                        ...
                        <div class="CRBoxCont row">
                            <div class="col-lg-8 col-md-12" style="margin: auto;">
                                <div class="" style=" margin: auto;">
                                    <div class="row">
                                        <p class="responses-date1 text-start">{{$request->created_at}}</p>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-9 col-sm-8 col-md-8 col-lg-8 col-xxl-9 text-start ConformRequestCol2">
                                            <div class="d-flex" style="justify-content: space-between;">
                                                ...
                                                <div class="d-flex flex-wrap">
                                                    <span class="QuotationButton">${{$request->price}}</span>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col d-flex" style="justify-content: space-between;">
                                                    <div class="d-flex lebardolocation">
                                                        ...
                                                        <p class="Position-t1 text-start">{{$request->position}}</p>
                                                    </div>
                                                    <div class="CRButton3">
                                                        <a href="">
                                                            @if($request->urgent=='Urgent')<p class="imgtopurgent" style="font-size: 17px;">Urgent</p>
                                                            @endif
                                                        </a>
                                                    </div>
                                                </div>
                            ...
                            <div class="row pt-5 buttontop">
                                ...
                                <div class="col-6 col">
                                    ...
                                    <a onclick="document.getElementById('my_form').submit();" href="javascript:{}">

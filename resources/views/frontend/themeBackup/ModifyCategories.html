...
<head>
    ...
    <link rel="stylesheet" href="ModifyCategoriesStyle.css">
...
<body style="zoom:90%">
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" style="background-color: white;box-shadow: 0px 2px 5px #acacac;">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse" style="margin-left:6%">
                <div class="navbar-nav">
                    ...
                    <a style=" padding-top: 10px;color: white;font-weight: bold;" href="PublishRequest.html" class="nav-item nav-link nav-publish publishnavbar">Publish a Request</a>
                </div>
                ...
                <div class="CCDIVcontainer">
                    ...
                    <div class="ChoseAddEditC row p-2">
                        ...
                        <div class="col-2 col-sm-1 text-end">
                            <a href="ModifyCategoryEdit.html">

...
<html lang="en">
    <head>
        ...
        <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css" rel="stylesheet"
            ...
            <link rel="stylesheet" href="MobileChatMessageBlueStyle.css">
                            ...
                            <div class="col-12 col-sm-12" style="margin: auto;">
                                <div class="row">
                                    <div class="onlineCard card" style="max-width: 540px;">
                                        <div class="row g-0">
                                            <div class="col-3 col-sm-3 text-end">
                                                <a href="BlueMobileChatProfile.html">
                                            ...
                                            <div class="col-9 col-sm-9">
                                                <div class="card-body">
                                                    ...
                                                    <div class="row">
                                                        <p
                                                            style="color: #3de3e6;font-weight: 500;margin-bottom: 0;margin-left: 0.7rem;">
                                                        Private</p>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="LookingForMoveRow2 row">
                                    ...
                                    <div class="row" style="display: block; height: 8rem;">
                                        ...
                                        <a href="">
                                            <img src="icons/blueicon.png" style="width: 2.5rem;" class="chaticon">
                                        </a>
                                    </div>
                                </div>
                            </div>

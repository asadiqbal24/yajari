        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse" style="margin-left:6%">
                <div class="navbar-nav">
                    <a style=" padding-top: 10px;color: #3B3B3B;font-weight: bold;position: relative;left: 4px;" href="HomePage.html" class="nav-item nav-link active">Home</a>
        ...
        <div class="PIcontainer container">
            <div class="row">
                ...
                <div class="col d-flex">
                    <img src="icons/Group 1913.png" style="width: 1.3rem;height: 1.8rem;">
                    ...
                    <div class="row">
                        <div class="form-group">
                            ...
                            <div class="input-group-addon">
                                <a href=""><img class="passwordEye" src="icons/ic_visibility_off_24px.png"></a>
                            </div>
                        </div>
                    </div>
                    <div class="row">
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="Modal4Body modal-bodylogin">
                        ...
                        <div class="input-group mb-2">
                            <input type="text" style="display:none;border-radius: 10px 10px 10px 10px;font-size: 12px;" class="Modal4input4 form-control professional" placeholder="SIRET Number" aria-label="SIRET Number" aria-describedby="basic-addon1">
                        </div>
                        <div class="input-group mb-2">
